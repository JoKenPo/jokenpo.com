...
/* harmony import */ var src_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4515);
/* harmony import */ var src_lib_config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7590);
/* harmony import */ var src_lib_get_site_map__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6841);
/* harmony import */ var src_lib_resolve_notion_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7042);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([src_components__WEBPACK_IMPORTED_MODULE_2__, src_lib_config__WEBPACK_IMPORTED_MODULE_3__, src_lib_get_site_map__WEBPACK_IMPORTED_MODULE_4__, src_lib_resolve_notion_page__WEBPACK_IMPORTED_MODULE_5__]);
([src_components__WEBPACK_IMPORTED_MODULE_2__, src_lib_config__WEBPACK_IMPORTED_MODULE_3__, src_lib_get_site_map__WEBPACK_IMPORTED_MODULE_4__, src_lib_resolve_notion_page__WEBPACK_IMPORTED_MODULE_5__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const getStaticProps = async (context)=>{
    ...
    try {
        const props = await (0,src_lib_resolve_notion_page__WEBPACK_IMPORTED_MODULE_5__/* .resolveNotionPage */ .g)(src_lib_config__WEBPACK_IMPORTED_MODULE_3__/* .domain */ .nw, rawPageId);
        return {
            props,
            revalidate: 10
        };
    } catch (err) {
        console.error("page error", src_lib_config__WEBPACK_IMPORTED_MODULE_3__/* .domain */ .nw, rawPageId, err);
...
async function getStaticPaths() {
    if (src_lib_config__WEBPACK_IMPORTED_MODULE_3__/* .isDev */ .r8) {
        return {
            paths: [],
            fallback: true
        };
    }
    const siteMap = await (0,src_lib_get_site_map__WEBPACK_IMPORTED_MODULE_4__/* .getSiteMap */ .P)();
    const staticPaths = {
...
function NotionDomainDynamicPage(props) {
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(src_components__WEBPACK_IMPORTED_MODULE_2__/* .NotionPage */ .mK, {
        ...props
    });
};
...
var __webpack_exports__ = __webpack_require__.X(0, [952,157,590,392,515,841,42], () => (__webpack_exec__(650)));
