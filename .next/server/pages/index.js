...
/* harmony import */ var src_lib_resolve_notion_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7042);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([src_components__WEBPACK_IMPORTED_MODULE_2__, src_lib_config__WEBPACK_IMPORTED_MODULE_3__, src_lib_resolve_notion_page__WEBPACK_IMPORTED_MODULE_4__]);
([src_components__WEBPACK_IMPORTED_MODULE_2__, src_lib_config__WEBPACK_IMPORTED_MODULE_3__, src_lib_resolve_notion_page__WEBPACK_IMPORTED_MODULE_4__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const getStaticProps = async ()=>{
    try {
        const props = await (0,src_lib_resolve_notion_page__WEBPACK_IMPORTED_MODULE_4__/* .resolveNotionPage */ .g)(src_lib_config__WEBPACK_IMPORTED_MODULE_3__/* .domain */ .nw);
        return {
            props,
            revalidate: 10
        };
    } catch (err) {
        console.error("page error", src_lib_config__WEBPACK_IMPORTED_MODULE_3__/* .domain */ .nw, err);
...
var __webpack_exports__ = __webpack_require__.X(0, [952,157,590,392,515,841,42], () => (__webpack_exec__(441)));
